...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Welcome, {{ auth('member')->user()->name }}!</h1>
            <p class="mt-2 text-gray-600">Manage your courses and track your learning progress</p>
        </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            ...
                            <a href="{{ route('member.verification.notice') }}" class="font-medium underline">
